...
# made network as similar as possible with fall_week_2/dqn_agent.py
...
class ReplayBuffer():
    ...
    def sample_buffer(self, batch_size):
        ...
        batch = np.random.choice(max_mem, batch_size, replace=False)    # replace = False: don't want to sample the same memory twice
...
class Agent():
    def __init__(self, lr, gamma, n_actions, epsilon, batch_size, input_dims, epsilon_dec=5e-4, eps_end=0.05, mem_size = 100000,
            fc1_dims = 256, fc2_dims = 256, replace = 100):
